...
- Switched key type on ServiceManager from string to Enum
- Fixed bug with deprecated playerHalfWidth value messing up player positioning on tap after refactoring from canvas to world
