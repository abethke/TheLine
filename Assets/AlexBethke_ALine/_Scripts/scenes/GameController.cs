...
namespace ALine
{
    ...
    public class GameController : MonoBehaviour, IGameController
    {
        ...
        {
            ServiceManager.instance.Add<IGameController>(this);
        }
        ...
        {
            ServiceManager.instance.Remove<IGameController>();
        }
        ...
        {
            yield return new WaitForSeconds(_config.gameOverDurationInSeconds);
        ...
        public void OnWallCollision(WallSegment in_wall, Collider2D in_other)
        {
            ...
            if (invincible)
            {
                _roadBuilder.RemoveWall(in_wall);
            }
            else
            {
                in_wall.Blink();
